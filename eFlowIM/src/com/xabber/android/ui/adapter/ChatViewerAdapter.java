...
public class ChatViewerAdapter extends BaseAdapter implements SaveStateAdapter,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			chatViewHolder.more_function_btn.setOnClickListener(onClickListener);
			chatViewHolder.voice_input_toggle.setOnClickListener(onClickListener);
			chatViewHolder.talkmessage_pic.setOnClickListener(onClickListener);
			chatViewHolder.talkmessage_camera.setOnClickListener(onClickListener);
			
			chatViewHolder.title.setOnClickListener(onClickListener);
			chatViewHolder.input.setOnKeyListener(onKeyListener);
			chatViewHolder.input.setOnEditorActionListener(onEditorActionListener);
			...
			chatViewHolder.list.setOnCreateContextMenuListener(onCreateContextMenuListener);
	...
	public void setPercent(View view, int per) {
		ChatViewHolder holder = (ChatViewHolder) view.getTag();
		holder.chatMessageAdapter.updatePercent(per);
	}
	...
	private static class ChatViewHolder {
		...
		final View send;
		final View more_function_btn;
		final View voice_input_toggle;
		final View talkmessage_pic;
		final View talkmessage_camera;
		...
		public ChatViewHolder(View view, ChatMessageAdapter chatMessageAdapter) {
			...
			more_function_btn = view.findViewById(R.id.more_function_btn);
			voice_input_toggle = view.findViewById(R.id.voice_input_toggle);
			talkmessage_pic = view.findViewById(R.id.talkmessage_pic);
			talkmessage_camera = view.findViewById(R.id.talkmessage_camera);
